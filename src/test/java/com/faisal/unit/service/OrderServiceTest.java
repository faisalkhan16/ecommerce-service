...
class OrderServiceTest {
    ...
    void placeOrder_shouldCreateOrderWithoutDiscount() {
        ...
        // subtotal = 200
        when(discountService.totalDiscount(eq(role), any(BigDecimal.class)))
    ...
    void placeOrder_shouldHandleNullDiscountAsZero() {
        ...
        when(discountService.totalDiscount(any(), any()))
                .thenReturn(null);
    ...
    void placeOrder_userRole_shouldApplyNoDiscount() {
        ...
        orderService.placeOrder(1L, Role.USER, List.of(item));
    ...
    void placeOrder_premiumUser_shouldApply10PercentDiscount() {
        ...
        orderService.placeOrder(1L, Role.PREMIUM_USER, List.of(item));
